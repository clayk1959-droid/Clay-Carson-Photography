...
const photographs = data.displayOrder.map((number) => ({
  ...
  src: `/galleries/christian-2nd-year/christian-2nd-year-${String(number).padStart(2, "0")}.jpg`,
}));

const hiddenPhotographs = data.photographData
  .map((photo, index) => ({
    ...photo,
    src: `/galleries/christian-2nd-year/christian-2nd-year-${String(index + 1).padStart(2, "0")}.jpg`,
  }))
...
export default function Christian2NdYearPage() {
